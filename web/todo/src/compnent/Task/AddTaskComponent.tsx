...
const initialImage = "";
  ...
  return (
    <>
      <form>
        <Box marginBottom={5}>
          ...
          <Box className="image-picker-container" display="flex" justifyContent="center" alignItems="center">          <ReactImagePickerEditor
      config={config2}
    ...
    /></Box></Container>
          ...
          <DatePickerCompnent />
          <Box></Box>
          <Box marginTop={5} marginLeft={30} marginRight={30} width={100}>
            <Button
              variant="contained"
              size="large"
              type="submit"
